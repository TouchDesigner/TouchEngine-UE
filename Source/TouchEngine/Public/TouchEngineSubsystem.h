...
public:
	...
	UPROPERTY(Transient)
	TArray<FTouchDynamicVariable> Inputs;
	// Dynamic variable outputs
	UPROPERTY(Transient)
	TArray<FTouchDynamicVariable>	Outputs;
	...
	UFUNCTION()
	void ParamsLoaded(TArray<FTouchDynamicVariable> new_inputs, TArray<FTouchDynamicVariable> new_outputs);
