...
#include "Fileparams.generated.h"
...
public:
	...
	FTouchOnParametersLoaded ParamsLoadedDelegate;
	FTouchOnFailedLoad FailedLoadDelegate;
	...
	void OnParamsLoaded(const TArray<FTouchEngineDynamicVariableStruct>& InInputs, const TArray<FTouchEngineDynamicVariableStruct>& InOutputs);
	void OnFailedLoad(const FString& Error);
